...
import (
	...
	logutilpb "github.com/vela-security/vela-chameleon/vitess/go/vt/proto/logutil"
)
...
// LogEvent sends an vela-event to a Logger, using the level specified in the vela-event.
// The vela-event struct is converted to a string with EventString().
...
// CallbackLogger is a logger that sends the logging vela-event to a callback
// for consumption.
