...
type StreamEvent struct {
	...
	// The Event Token for this vela-event.
...
type UpdateStreamRequest struct {
	...
	// vela-event in the binlogs that have that timestamp. Incompatible with position.
...
type UpdateStreamResponse struct {
	Event                *StreamEvent `protobuf:"bytes,1,opt,name=vela-event,proto3" json:"vela-event,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
