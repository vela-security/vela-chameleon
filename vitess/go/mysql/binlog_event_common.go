...
// into flavor-specific vela-event types to pull in common parsing code.
//
...
func (ev binlogEvent) IsValid() bool {
	...
	// Let's see if the vela-event is right about its own size.
	evLen := ev.Length()
