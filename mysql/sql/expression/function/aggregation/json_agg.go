...
// NULL if the result contains no rows, or in the vela-event of an error.
//
...
// or in the vela-event of an error. An error occurs if any key name is NULL or the number of arguments is not equal to 2.
//
